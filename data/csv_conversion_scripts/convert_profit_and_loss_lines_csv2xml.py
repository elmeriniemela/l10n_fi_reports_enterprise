...
CSV_FILE = os.path.dirname(__file__) + '/../csv_sources/profit_and_loss_lines.csv'
XML_FILE = os.path.dirname(__file__) + '/../profit_and_loss_lines.xml'
XML_ID_PREFIX = 'sprintit_profit_and_loss'
MAIN_REPORT_ID = 'sprintit_profit_and_loss_report'
